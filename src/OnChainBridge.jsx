      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",minWidth:0,paddingBottom:"env(safe-area-inset-bottom)"}}>
        ...
        <main className="ocb-main" style={{flex:1,padding:"24px",overflowY:"auto"}}>
          ...
          {phase==="dashboard" && d && <div style={{animation:"fadeUp .3s"}}>
            ...
            <div style={{padding:"10px 16px",borderRadius:8,background:C.surface,border:`1px solid ${C.border}`,fontSize:11,color:C.muted,display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}}><span style={{display:"flex",alignItems:"center",gap:4}}><span style={{width:6,height:6,borderRadius:"50%",background:C.accent,display:"inline-block"}}/> Powered by <span style={{color:C.accent,fontWeight:600}}>Groq Llama 3.3 70B</span> · Solana protocols via <span style={{color:C.accent,fontWeight:600}}>DeFiLlama</span></span><span style={{color:C.muted}}> · </span><span>Results are less detailed than our production model. Full accuracy post-grant.</span></div>
