...
SOLANA PRIORITY: Prefer Solana protocols. Key protocols: Marinade, Jito, Kamino, Orca, Helio, Solana Pay, Ondo, Helium, Hivemapper, Render, Realms, Squads, Civic, Pyth. Only use other chains when genuinely stronger.
